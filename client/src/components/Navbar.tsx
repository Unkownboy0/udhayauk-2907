...
export function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-background/95 backdrop-blur-lg border-b border-border shadow-lg`}
      data-testid="navbar"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-center h-20 relative">
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#courses" className="text-foreground hover:text-primary transition-colors" data-testid="link-courses">
              Courses
            </a>
